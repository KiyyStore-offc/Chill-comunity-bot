...
module.exports = {
  name: 'source',
  category: 'Config',
  description: 'Set your preferred music source for id prefer Spotify because My love Aki likes Spotify',
  cooldown: 5,
  slashOptions: [
    {
      name: "source",
      description: "Choose your preferred music source\n spotify i prefer ahh all credits to my love aki 🌷",
      type: 3,
      required: true,
      choices: [
  ...
  async execute(message, args, client, prefix) {
    try {
      ...
      const selectMenu = new StringSelectMenuBuilder()
        ...
        .setPlaceholder('Chooss any id prefer Spotify cuz my love Aki like it')
