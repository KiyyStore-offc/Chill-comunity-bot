...
module.exports = {
  name: 'cry',
  category: 'Reaction',
  description: 'Express your sadness with an anime crying GIF',
  cooldown: 3,
  slashOptions: [],
  ...
  async _run(ctx, client) {
    ...
    const { url } = await fetchGif('cry');
    const media = new MediaGalleryBuilder().addItems(new MediaGalleryItemBuilder().setURL(url));
    const container = new ContainerBuilder()
      .addTextDisplayComponents(new TextDisplayBuilder().setContent(`### ${emoji.cry} Crying...\n**${author.username}** is crying... 😢 Someone comfort them!\n-# Powered by Chill • Developed by AkiForver`))
